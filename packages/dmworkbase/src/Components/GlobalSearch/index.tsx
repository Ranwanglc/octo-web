...
import GlobalChatSearchPanel from "../../features/globalChatSearch/GlobalChatSearchPanel";
import { createGlobalSearchApiDataSource } from "./dataSource";
import { selectedGlobalSearchFilterValueCount } from "./filterState";
            ...
            <div>
              ...
              <div className="wk-search-tabs">
                ...
                {this.contentSearchEnabled && isGlobalContentTab && (
                  <div className="wk-search-tabs__filter-actions">
                    {filterCount > 0 && (
                      <button
                        type="button"
                      ...
                      >
                        {translate("base.globalSearch.aggregated.resetFilters")}
                      </button>
                    )}
                    <button
                      type="button"
                    ...
                    >
                      <Filter
                        size={16}
                        fill={this.state.filterOpen ? "currentColor" : "none"}
                      />
                      {filterCount > 0 && (
                      ...
                      <span>
                        {translate("base.globalSearch.aggregated.filterTitle")}
                      </span>
                    </button>
                  </div>
                )}
