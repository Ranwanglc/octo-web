...
export function isAudio(extension: string, name?: string): boolean {
  const ext = getExtension(extension, name);
...
export class FileCell extends MessageCell<any, FileCellState> {
  ...
  render() {
    ...
    const audioUrl = isAudio(content.extension, content.name)
      ? resolveSafeFileUrl(content)
      : "";
    ...
    if (audioUrl) {
      return (
        ...
        >
          <div className="wk-message-file-audio">
            <div className="wk-message-file-audio-main">
              <div className="wk-message-file-audio-info">
                <div
                  className="wk-message-file-audio-name"
                  title={content.name}
                >
                  {content.name || t("base.messageFile.unknownFile")}
                </div>
                <div className="wk-message-file-audio-meta">
